...
console.log("Grades Text Check: First='Mikaela' vs Doc 'LANTAFE, MIKAELA YSABEL LINATOC':", studentNameMatchesText(gradesText, "Mikaela", "L", "Lantafe"));
console.log("Grades Text Check: First='Mikaela Ysabel' vs Doc 'LANTAFE, MIKAELA YSABEL LINATOC':", studentNameMatchesText(gradesText, "Mikaela Ysabel", "L", "Lantafe"));
