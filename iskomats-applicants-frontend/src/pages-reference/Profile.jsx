...
const Profile = () => {
  ...
  const handleProfileSubmit = (e) => {
    ...
    const profiles = JSON.parse(localStorage.getItem('userProfiles')) || {};
    const isNewProfile = !profiles[currentUser]; // Check if profile exists before saving
    ...
    setTimeout(() => {
      ...
      if (isNewProfile) {
        // New profile created, redirect to portal
        navigate('/portal');
      } else {
        // Profile updated, show display view
        setShowEditForm(false);
      }
    }, 2000);
  };
  ...
  const getFirstName = () => {
    return userProfile?.fullName?.split(' ')[0] || 'Student';
  };
            ...
            <div className="profile-display-section">
              <div className="profile-display-header">
                ...
                <div className="profile-info">
                  <h3>{userProfile.fullName || 'No name provided'}</h3>
                  <p className="email">{currentUser}</p>
                </div>
              </div>
              <div className="profile-details">
                <div className="detail-item">
                  <div className="label">University / School</div>
                  <div className="value">{userProfile.university || 'No university provided'}</div>
                </div>
                <div className="detail-item">
                  <div className="label">Phone Number</div>
                  <div className="value">{userProfile.phoneNumber || 'No phone provided'}</div>
                </div>
                <div className="detail-item">
                  <div className="label">Address</div>
                  <div className="value">{userProfile.address || 'No address provided'}</div>
                </div>
                <div className="detail-item">
                  <div className="label">Birthdate</div>
                  <div className="value">{formatBirthdate(userProfile.birthdate)}</div>
                </div>
              </div>
              <button className="edit-profile-btn" style={{marginTop: '2rem'}} onClick={showEditProfile}>
